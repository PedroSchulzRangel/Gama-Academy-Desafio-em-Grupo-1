...
// Para cada produto, percorrer cada um dos departamentos da lista, fazendo as devidas somatórias (tanto de quantidade de itens quanto de preços)
...
// Para cada produto, percorrer cada um dos departamentos da lista, fazendo as devidas somatórias
    ...
    for (j=0;j<listaDeptos.length;j++){
        if(maiorSoma < listaDeptos[j].totalValorDosItens){
            maiorSoma = listaDeptos[j].totalValorDosItens;
            DeptoMaisValioso = listaDeptos[j].nomeDepto; 
        }
    }    
